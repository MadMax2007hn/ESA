...
def show_graphs():
    ...
    x_values3 = np.arange(0, (length * (1 / interval)) * interval, interval)
...
# Full-screen button
fullscreen_button = ttk.Button(extra_settings_frame,
                               text="⛶",
                               command=toggle_fullscreen)
fullscreen_button.pack(side=tk.RIGHT, padx=10)

# Button to show log
show_log_button = ttk.Button(extra_settings_frame,
                             text="Log Anzeigen",
                             command=show_log)
...
interval_label = ttk.Label(root, text="Δm/Masseänderung:")
interval_label.pack()
interval_entry = ttk.Entry(root)
interval_entry.insert(0, "")  # Default interval
interval_entry.pack()
interval_entry.bind("<KeyRelease>", interval_length_changed)

interval_label = ttk.Label(root, text="ve/Geschwindigkeit der ausgestoßenen Gase relativ zur Rakete:")
interval_label.pack()
interval_entry = ttk.Entry(root)
interval_entry.insert(0, "")  # Default interval
interval_entry.pack()
...
# Impressum button
impressum_button = ttk.Button(footer_frame,
                              text="Impressum",
...
load_button = ttk.Button(footer_frame,
